...
// частично специализированный класс Pair, в котором первый параметр — string, а второй — любого типа данных.
...
int main()
{
    // Task 1. Следующий код должен производить результат:
    //  Pair: 6 9
    //  Pair : 3.4 7.8
    ...
    // Task 2. Следующий код должен производить следующий результат:
    // Pair: 6 7.8
    // Pair : 3.4 5
    ...
    // Task 3. Следующий код должен производить следующий результат:
    // Pair: Amazing 7
